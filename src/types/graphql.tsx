...
export type ListingFragment = (
  { __typename?: 'Listing' }
  & Pick<Listing, 'id' | 'title' | 'createdAt' | 'description' | 'price' | 'status' | 'player'>
  & { images: Array<(
    { __typename?: 'ListingImage' }
...
export function useToggleFavoriteMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<ToggleFavoriteMutation, ToggleFavoriteMutationVariables>) {
        return ApolloReactHooks.useMutation<ToggleFavoriteMutation, ToggleFavoriteMutationVariables>(ToggleFavoriteDocument, baseOptions);
      }
